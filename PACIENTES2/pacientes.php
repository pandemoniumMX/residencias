      ...
      <div id="content">
        ...
        <div class="table-responsive table--no-card m-b-30">
                              <table class="table table-borderless table-striped table-earning">
                                  ...
                                  <tbody>
                                    <?php
                                    $public = "SELECT * FROM pacientes where estatus='A'";
                                  ...
                                  while($fila=mysqli_fetch_array($ejecutar)){
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                         <button title="Editar" onclick="get_edit(<?php echo $id ?>),get_mod(<?php echo $id ?>)" data-original-title="Edit">
                                         <i class='btn-sm btn-success fa fa-edit'></i>
                                          </button>
...
<script>
       ...
       // $("#idp").val(data.data.id_car);
        $("#id_pac").val(data.data.idx);  
        $("#pac_apaterno").val(data.data.pac_apaterno);   
        $("#pac_amaterno").val(data.data.pac_amaterno);
        $("#pac_nombre").val(data.data.pac_nombre);        
        $("#pac_fecha_nacimiento").val(data.data.pac_fecha_nacimiento);
	      $("#pac_telefono").val(data.data.pac_telefono);
